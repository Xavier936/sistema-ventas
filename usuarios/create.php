                ...
                <div class="col-md-12">
                  <form action="../app/controllers/usuarios/crear_usuarios.php" method="post">
                    <div class="form-group">
                      ...
                      <input  name="txt_nombre" type="text" class="form-control" placeholder="Ingrese un nombre y un apellido">
                    </div>
                    <div class="form-group">
                      <label for="">Email</label>
                      <input name="txt_email"type="email" class="form-control" placeholder="Ingrese un correo valido">
                    </div>
                    <div class="form-group">
